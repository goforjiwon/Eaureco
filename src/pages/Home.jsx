      ...
      <section id="solution" className="py-16 px-4 section-surface">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-1 gap-8 mb-20">
            <motion.div
              ...
              <div className="content-card p-8 h-full">
                ...
                <p className="text-3xl font-bold text-gray-900 mb-2">{t.solution.performance.greenTitle}</p>
          ...
          <motion.div
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-12">{t.solution.general.title}</h2>
          ...
          <motion.div
            ...
            <div className="content-card p-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">{t.solution.impact.title}</h2>
                ...
                <div className="content-card p-8">
                  <div className="grid grid-cols-2 gap-8">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-emerald-600">{t.comparison.value.cheap}</p>
                    </div>
                    <div className="text-center">
                      <TrendingUp className="w-12 h-12 text-cyan-600 mx-auto mb-3" strokeWidth={2} />
                      <p className="text-3xl font-bold text-cyan-600">{t.comparison.value.effective}</p>
                    </div>
                  </div>
                </div>
              </div>
