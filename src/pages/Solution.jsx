              ...
              <div className="text-white">
                ...
                <div className="flex flex-wrap gap-4 mb-8">
                  {t.esg.benefits.map((benefit, idx) => (
                    <div key={idx} className="flex items-center gap-2 bg-white/20 backdrop-blur rounded-full px-4 py-2 border border-white/30">
                      <CheckCircle className="w-5 h-5 flex-shrink-0" strokeWidth={2.5} />
                      <span className="text-base font-medium whitespace-nowrap">{benefit}</span>
                    </div>
                  ))}
                </div>
